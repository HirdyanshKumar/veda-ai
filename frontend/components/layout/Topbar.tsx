  ...
  return (
    ...
    >
      ...
      <div className="flex md:hidden items-center gap-3">
        ...
        {/* User Profile Avatar */}
        <div className="w-11 h-11 rounded-full overflow-hidden border border-[#E2E8F0] shadow-sm select-none">
          <img 
      ...
      <div className="hidden md:flex items-center gap-4">
        ...
        <button className="flex items-center gap-2 hover:bg-[#F3F4F6] p-1.5 rounded-lg transition-colors active:scale-[0.98]">
          {/* Avatar circle: 32px */}
          <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-[#A5D6A7] to-[#80CBC4] flex items-center justify-center shadow-inner border border-[#E0F2F1]">
            <span className="text-[12px] font-bold text-[#004D40]">JD</span>
          </div>
